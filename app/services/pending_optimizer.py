...
class PendingOptimizer:
    ...
    def get_roll_suggestions(self, wastage: float) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"🔍 ORDER GROUPING DEBUG:")
            ...
            for order_id, order_data in order_groups.items():
                ...
                for pid in pending_ids_in_group:
                    if pid in all_pending_ids_used:
                        logger.error(f"🚨 DUPLICATE PENDING ID {pid[:8]} found in multiple order groups!")
            ...
            for suggestion in order_suggestions:
                for jumbo_roll in suggestion['jumbo_rolls']:
            ...
            return {
                ...
                "summary": {
                    ...
                    "expected_cut_rolls": total_expected_cut_rolls  # Add this for comparison
                }
            }
